...
class StoryApp:
    ...
    def button_show(self):
         self.start_button = tk.Button(self.master, text="Start", command=self.toggle_prologue, fg="#F5F5DC", bg="#8B4513", bd=4, relief=tk.RAISED, font=("woodland,20"))
         self.start_button.pack(pady=20)
    def background(self):
        if self.story_index <= 4:
    ...
    def toggle_prologue(self):
        self.protext = tk.Label(self.master, text="Welcome to the Prologue", font=("woodland, 14"), fg="#F5F5DC", bg="#8B4513", bd=4, relief=tk.RIDGE)
        self.protext.pack(pady=5)
        self.protext2 = tk.Label(self.master, text="You've been Stranded on a Remote Island after a Plane Malfunction.", font=("woodland, 10"), fg="#F5F5DC", bg="#8B4513", bd=3, relief=tk.GROOVE)
        self.protext2.pack(pady=2)
        self.protext3 = tk.Label(self.master, text="The Pilot was able to Radio a Distress Signal Before Impact.", font=("woodland, 10"), fg="#F5F5DC", bg="#8B4513", bd=3, relief=tk.GROOVE)
        self.protext3.pack(pady=2)
        self.protext4 = tk.Label(self.master, text="But Your Exact Location Remains Unclear.", font=("woodland, 10"), fg="#F5F5DC", bg="#8B4513", bd=3, relief=tk.GROOVE)
        self.protext4.pack(pady=2)
        self.protext5 = tk.Label(self.master, text="Your Survival Skills and Resourcefulness will be put to the Test as you wait for Rescue.", font=("woodland, 10"), fg="#F5F5DC", bg="#8B4513", bd=3, relief=tk.GROOVE)
        self.protext5.pack(pady=2)
        self.protext6 = tk.Label(self.master, text="Expect the Worst, Discover the Unkown. Trust no one.",font=("woodland, 10"), fg="#F5F5DC", bg="#8B4513", bd=3, relief=tk.GROOVE)
